...
public:
    ...
    void RegistrirajUtakmicu(const char tim1[], const char tim2[], int rezultat_1, int rezultat_2){
        ...
        for(int i=0; i<broj_timova; i++) if(strcmp(timovi[i]->DajImeTima(),tim1)==0) nadjen1=true;
        for(int i=0; i<broj_timova; i++) if(strcmp(timovi[i]->DajImeTima(),tim2)==0) nadjen2=true;
    ...
    void IspisiTabelu(){
        ...
        std::for_each(timovi, timovi+broj_timova, [](Tim *tim){tim->IspisiPodatke();});
    }
};
int main ()
{
